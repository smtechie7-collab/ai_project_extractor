...
class TraditionalRenderer : BaseRenderer {
    ...
    override fun render(
        ...
        TableComponent(canvas, invoiceData, layout, template, paints).draw() // Table component uses table-specific Ys from layout
